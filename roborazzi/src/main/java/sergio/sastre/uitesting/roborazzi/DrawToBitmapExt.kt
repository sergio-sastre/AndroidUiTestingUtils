...
internal fun View.drawToBitmap(bitmapCaptureMethod: BitmapCaptureMethod?): Bitmap =
...
internal fun Dialog.drawToBitmap(bitmapCaptureMethod: BitmapCaptureMethod?): Bitmap =
