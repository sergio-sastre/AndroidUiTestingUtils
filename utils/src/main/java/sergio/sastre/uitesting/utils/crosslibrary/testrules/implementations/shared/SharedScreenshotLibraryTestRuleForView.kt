...
abstract class SharedScreenshotLibraryTestRuleForView (
    ...
    abstract fun getJvmScreenshotLibraryTestRule(config: ScreenshotConfigForView): ScreenshotTestRuleForView

    abstract fun getInstrumentedScreenshotLibraryTestRule(config: ScreenshotConfigForView): ScreenshotTestRuleForView
